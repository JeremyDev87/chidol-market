				...
				<div className="mb-8">
					{data?.product?.image ? (
						<div className="relative pb-80">
							<Image
								src={`https://imagedelivery.net/2iJLoPGas2aEZaOOZmqvww/${data.product.image}/public`}
					...
					<div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
						{data?.product?.user?.avatar ? (
							<Image
								height={48}
								width={48}
								src={`https://imagedelivery.net/2iJLoPGas2aEZaOOZmqvww/${data.product.user.avatar}/avatar`}
